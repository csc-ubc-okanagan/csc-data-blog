...
```{r data preparation, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
library(readr)
library(dplyr)
...
```{r meta_analysis, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
# ── 0. Packages ───────────────────────────────────────────────
library(readr)
library(meta)
...
```{r meta_analysis_2, echo=TRUE, results='markup', message=FALSE, warning=FALSE}
