...
The deterministic model (orange) underestimates population growth compared to the geometric mean (blue). After 50 years, the deterministic model predicts `r round(N_function_of_mean[50], 0)`, while the geometric mean is only `r round(N_geometric_mean[50], 0)`
